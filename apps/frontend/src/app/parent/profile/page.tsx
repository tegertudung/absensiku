...
export default function ParentProfilePage() {
  ...
  const initial = (profile?.name || user?.email || "O")
    .trim()
    .charAt(0)
    .toUpperCase();
  const accountRows = [
        ...
        <>
          <section className="relative overflow-hidden rounded-2xl border border-gray-100 bg-white px-5 py-7 text-center shadow-sm">
            ...
            <div className="relative">
              ...
              <p
                className={`mx-auto mt-3 max-w-[18rem] break-all text-[13px] text-gray-500 ${loading ? "h-4 animate-pulse rounded bg-gray-100 text-transparent" : ""}`}
              >
              ...
              {loading ? (
                ...
                profile.children.map((child, index) => (
                  <div
                    ...
                    className={`px-4 py-3.5 ${index > 0 ? "border-t border-gray-100" : ""}`}
                  >
                    ...
                    <p className="mt-1 break-words text-[15px] font-medium text-navy-900">
                      {child.student.name}
                    </p>
                    {child.relationship && (
                ...
                <div className="px-4 py-4 text-sm leading-5 text-gray-500">
                  Belum ada anak yang terhubung ke akun ini. Hubungi Admin.
                </div>
              )}
            </div>
          </section>
