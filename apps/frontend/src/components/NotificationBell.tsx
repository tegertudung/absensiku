...
interface NotificationBellProps {
  // When set, the bell navigates to this route instead of opening the
  // dropdown — used on Tentor, whose mockup has a dedicated full-page
  // "Notifikasi" screen rather than a header dropdown (kept as-is for Admin).
  href?: string;
}
...
export default function NotificationBell({ href }: NotificationBellProps = {}) {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => (href ? router.push(href) : setOpen((o) => !o))}
        className="relative flex h-11 w-11 items-center justify-center -m-1"
