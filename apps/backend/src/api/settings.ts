...
const router=Router();
const identity=z.object({systemName:z.string().min(1).optional(),institutionName:z.string().min(1).optional(),signatoryName:z.string().optional(),signatoryTitle:z.string().optional(),location:z.string().optional(),domain:z.string().optional(),logoPath:z.string().optional()});
