...
router.patch(
  ...
  async (req: Request, res: Response) => {
    try {
      res.json({
        success: true,
        data: await setTutorActive(req.params.id, false, req.user!.userId),
      });
    } catch (err) {
      handleError(err, res);
    }
...
router.patch(
  ...
  async (req: Request, res: Response) => {
    try {
      res.json({
        success: true,
        data: await setTutorActive(req.params.id, true, req.user!.userId),
      });
    } catch (err) {
      handleError(err, res);
    }
...
router.delete(
  ...
  async (req: Request, res: Response) => {
    try {
      res.json({
        success: true,
        data: await deleteTutor(req.params.id, req.user!.userId),
      });
    } catch (err) {
      handleError(err, res);
    }
